    ...
    public class MShootable : MWeapon, IShootableWeapon, IThrower
    {
        ...
        public virtual void EquipProjectile()
        {
            ...
            if (ProjectileInstance == null) //Means there's no projectile equipped!
            {
                ...
                LoadProjectileReaction.React(UserGo); //React to the Load Projectile
        ...
        public virtual void FireProjectile()
        {
            ...
            BeforeFireProjectileReaction.React(UserGo);
            ...
            if (MProjectile != null)
            {
                ...
                MProjectile.Prepare(UserGo, Gravity, Velocity, Layer, TriggerInteraction, ProjectilePool);
            ...
            FireProjectileReaction.React(UserGo); //React to the Fire Projectile
        ...
        public override bool TryReload()
        {
            ...
            if (HasReloadAnim.Value)
            {
                ...
                if (CanReload())
                {
                    ...
                    ReloadStartReaction.React(UserGo); //React to the Reload Start
        ...
        public bool ReloadLogic(int ReloadAmount)
        {
            if (TotalAmmo == -1) //Means that you will have Infinity Ammo
            {
                ...
                OnReload.Invoke();
                ReloadReaction.React(UserGo); //React to the Reload
                return true;
            }
