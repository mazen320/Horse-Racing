...
namespace MalbersAnimations.Weapons
{
    ...
    public abstract class MWeapon : MDamager, IMWeapon, IMDamager
    {
        ...
        public virtual bool IsEquipped
        {
            ...
            set
            {
                ...
                if (isEquipped && UserGo)
                {
                    OnEquiped.Invoke(UserGo.transform);
                    EquippedReaction.React(UserGo.transform);
                ...
                {
                    OnUnequiped.Invoke(UserGo ? UserGo.transform : null);
                    UnequipedReaction.React(UserGo ? UserGo.transform : null);
        ...
        public GameObjectEvent OnDroppedBy = new();
        #endregion
        ...
        {
            isEquipped = false;
            if (UserGo == null) UserGo = transform.root.gameObject;
    ...
    public abstract class MWeaponEditor : MDamagerEd
    {
        ...
        protected SerializedProperty
            ...
            m_AimSide, OnCharged, OnMaxCharged, OnAttackStarted, OnDroppedBy,
        ...
        protected virtual void SetOnEnable()
        {
            ...
            OnDroppedBy = serializedObject.FindProperty("OnDroppedBy");
        ...
        protected override void DrawCustomEvents()
        {
            ...
            EditorGUILayout.PropertyField(OnDroppedBy);
            ChildWeaponEvents();
        }
