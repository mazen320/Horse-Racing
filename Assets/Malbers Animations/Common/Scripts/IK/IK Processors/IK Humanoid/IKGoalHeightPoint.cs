...
namespace MalbersAnimations.IK
{
    ...
    /// 
    /// </summary>
    [Serializable, AddTypeMenu("Humanoid/IK Goal Height Point")]
    public class IKGoalHeightPoint : IKProcessorOnAnimIK
    {
        ...
        [SerializeField] LayerReference detectionLayer = new(1);
        ...
        {
            Vector3 origin = Bone.position + anim.transform.TransformDirection(sphereCastOffset);
        ...
        public override void OnDrawGizmos(IKManager manager, IKSet IKSet, Animator anim, float weight)
        {
            if (Bone != null)
            {
                ...
                Vector3 sphereCastOrigin = Bone.position + anim.transform.TransformDirection(sphereCastOffset);
