...
namespace MalbersAnimations.HAP
{
    ...
    public class MRider : MonoBehaviour, IAnimatorListener, IRider
    {
        ...
        public static readonly int IKLeftFootHash = Animator.StringToHash("IKLeftFoot");
        public static readonly int IKRightFootHash = Animator.StringToHash("IKRightFoot");
        public static readonly int MountHash = Animator.StringToHash("Mount");
        public static readonly int MountSideHash = Animator.StringToHash("MountSide");
        ...
        private void Debugging(string value, string color = "white")
        {
#if UNITY_EDITOR
    ...
    {
        public readonly string version = "Riding System - HAP [4.5.2b]";
        ...
        #region GUICONTENT
        private readonly GUIContent G_DisableComponents = new("Disable Components", "If some of the components are breaking the Rider Logic, disable them");
        private readonly GUIContent G_DisableList = new("Disable List", "Monobehaviours that will be disabled while mounted");
        ...
        private readonly GUIContent G_Parent = new("Parent to Mount", "Parent the Rider to the Mount Point on the Mountable Animal");
        private readonly GUIContent G_DismountType = new("Dismount Type", "Changes the Dismount animation on the Rider.\nRandom: Randomly select a Dismount Animation.\nInput: Select the Dismount Animation by the Horizontal and Vertical Input Axis.\n Last: Uses the Last Mount Animation as a reference for the Dismount Animation.");
        ...
        private void AddLayerMounted(UnityEditor.Animations.AnimatorController AnimController)
        {
