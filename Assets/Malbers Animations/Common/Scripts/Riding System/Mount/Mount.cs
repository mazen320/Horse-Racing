...
namespace MalbersAnimations.HAP
{
    ...
    public class MountEd : Editor
    {
        ...
        private void ShowGeneral()
        {
            ...
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                Set_InputMount.isExpanded = MalbersEditor.Foldout(Set_InputMount.isExpanded, "Set Values on Mounted");
            ...
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                Set_InputDismount.isExpanded = MalbersEditor.Foldout(Set_InputDismount.isExpanded, "Set Values on Dismounted");
