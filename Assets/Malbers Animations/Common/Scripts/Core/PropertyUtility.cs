...
namespace MalbersAnimations
{
    ...
    public static class PropertyUtility
    {
        ...
        {
            FieldInfo fieldInfo = MalbersReflection.GetField(GetTargetObjectWithProperty(property), property.name);
            if (fieldInfo == null)
            {
                return new T[] { };
            }
        ...
        internal static List<bool> GetConditionValues(object target, string[] conditions)
        {
            ...
            {
                FieldInfo conditionField = MalbersReflection.GetField(target, condition);
                ...
                PropertyInfo conditionProperty = MalbersReflection.GetProperty(target, condition);
                ...
                MethodInfo conditionMethod = MalbersReflection.GetMethod(target, condition);
