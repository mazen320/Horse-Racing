...
namespace MalbersAnimations
{
    ...
    public interface ICollectable : IObjectCore
    {
        ...
        /// <summary>MWC: Who is currently holding this collectable (null when free). Used to detect and resolve contested picks</summary>
        GameObject Picker { get; set; }

        /// <summary>MWC: Forces the current Picker (if any) to drop this collectable</summary>
        void ForceDrop();
