...
namespace MalbersAnimations
{
    ...
    public class AnimatorParamPropertyDrawer : PropertyDrawer
    {
        ...
        private static AnimatorController GetAnimatorController(SerializedProperty property, string animatorName)
        {
            ...
            FieldInfo animatorFieldInfo = MalbersReflection.GetField(target, animatorName);
            ...
            PropertyInfo animatorPropertyInfo = MalbersReflection.GetProperty(target, animatorName);
            ...
            MethodInfo animatorGetterMethodInfo = MalbersReflection.GetMethod(target, animatorName);
