...
namespace MalbersAnimations.Controller
{
    ...
    public class Zone : MonoBehaviour, IZone
    {
        ...
        [Tooltip("Extra conditions to check in case you want to activate the Zone. Dynamic Target [Entering Animal]")]
        ...
        private void OnTriggerEnter(Collider other)
        {
            if (TrueConditions(other))
            {
                ...
                if (!ActivationConditions.Evaluate(animal)) return;
            ...
            if (CheckAngle(animal))
            {
                ...
                switch (zoneType)
                {
                    ...
                    case ZoneType.ReactionsOnly:
                        isZoneActive = ActivationReaction.React(animal);
                        break;
                }
    ...
    public class ZoneEditor : Editor
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            ActivationReaction = serializedObject.FindProperty(nameof(Zone.ActivationReaction));
            ...
            m_tag = serializedObject.FindProperty("m_Tags");
