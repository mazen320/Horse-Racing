Shader "PBR/Lightweight/Horse Specular" {
	Properties {
		...
		[ToggleOff] _EnvironmentReflections ("Glossy Reflections", Float) = 1
		...
		_ForceDetailNormal ("Force Detail Map", Float) = 0
		...
		_QuartermarkMap ("Quartermark", 2D) = "gray" {}
