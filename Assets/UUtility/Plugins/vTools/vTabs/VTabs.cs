        ...
        class TabDescription
        {
                ...
                if (window.GetType() == inspectorType)
                    if (inspectorType.GetMethod("GetInspectedObject", maxBindingFlags).Invoke(window, null) is Object obj)
                    {
                        ...
                        if (path != "")
                            ...
                            objectInstanceId = (int)EntityId.ToULong(obj.GetEntityId());
            ...
            public TabDescription(Object lockTo)
            {
                ...
                else
                {
                    ...
                    objectInstanceId = (int)EntityId.ToULong(lockTo.GetEntityId());
                }
            ...
            public EditorWindow CreateWindow(object dockArea, bool atStoredTabIndex = true)
            {
                ...
                if (isBrowser)
                {
                    ...
                    if (objectGuid != "")
                    {
                        var iid = (int)EntityId.ToULong(AssetDatabase.LoadAssetAtPath<Object>(AssetDatabase.GUIDToAssetPath(objectGuid)).GetEntityId());
                ...
                if (isInspector)
                {
                    ...
                    if (objectInstanceId != 0)
                        obj = EditorUtility.EntityIdToObject(objectInstanceId);
                    else
