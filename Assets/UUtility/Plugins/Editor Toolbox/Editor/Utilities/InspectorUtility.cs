...
namespace Toolbox.Editor
{
    ...
    internal static partial class InspectorUtility
    {
        ...
        private static void CheckReloads(Editor editor)
        {
            ...
            if (lastCachedEditor == null || lastCachedEditorId != (int)EntityId.ToULong(lastCachedEditor.GetEntityId()))
            {
                lastCachedEditor = editor;
                lastCachedEditorId = (int)EntityId.ToULong(editor.GetEntityId());
