...
namespace FullscreenEditor {
    ...
    public struct ViewPyramid {
        ...
        public EditorWindow Window {
            ...
            set {
                m_window = value;
                m_windowInstanceID = m_window ? (int)EntityId.ToULong(m_window.GetEntityId()) : 0;
            }
        }
        ...
        public View View {
            ...
            set {
                ...
                m_view = value;
                m_viewInstanceID = m_view ? (int)EntityId.ToULong(m_view.GetEntityId()) : 0;
            }
        }
        ...
        public ContainerWindow Container {
            ...
            set {
                ...
                m_container = value;
                m_containerInstanceID = m_container ? (int)EntityId.ToULong(m_container.GetEntityId()) : 0;
            }
        }
